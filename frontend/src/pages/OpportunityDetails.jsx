        ...
        <aside className="bg-white border rounded-xl shadow-sm p-4 space-y-4">
          ...
          <div className="pt-3 border-t border-gray-200 mt-2">
            ...
            {matchesLoading ? (
              ...
              <p className="text-xs text-gray-500">
                No matches yet for this opportunity.
              </p>
            ) : (
                ...
                {matches.map((v) => (
                  ...
                  >
                    ...
                    <p className="text-[11px] text-gray-500">
                      {v.location || "Location not specified"}
                    </p>
                    ...
                    <button
                      onClick={() => navigate(`/chat/${v.volunteerId}`)}
                      className="mt-2 inline-flex items-center px-3 py-1 rounded-full bg-emerald-500 text-white text-[11px] font-medium hover:bg-emerald-600"
                    >
                      Message volunteer
                    </button>
                  </div>
